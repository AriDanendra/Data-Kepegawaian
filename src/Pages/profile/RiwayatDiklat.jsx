    ...
    try {
      ...
      if (modalType === "add") {
        response = await axios.post(
          `/api/employees/${employeeId}/diklat`,
          dataToSend,
          {
        ...
        response = await axios.put(
          `/api/employees/${employeeId}/diklat/${selectedData.id}`,
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
    ...
    if (modalType === "delete" && selectedData) {
      return (
        <div>
          ...
          <p>
            <strong>{selectedData.namaDiklat}</strong>?
          </p>
          <div className="modal-form-actions">
            <button
              type="button"
      ...
      <div className="riwayat-header">
        <div>
          ...
          <p className="subtitle">
            Informasi riwayat diklat yang pernah diikuti.
          </p>
        </div>
        <button
