    ...
    try {
      ...
      if (modalType === "add") {
        ...
        response = await axios.put(
          `/api/employees/${employeeId}/skp/${selectedData.id}`,
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
