    ...
    try {
      ...
      if (modalType === "add") {
        response = await axios.post(
          `/api/employees/${employeeId}/skp-permenpan`,
          dataToSend,
          {
        ...
        response = await axios.put(
          `/api/employees/${employeeId}/skp-permenpan/${selectedData.id}`,
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
      ...
      console.error(
        "Gagal menyimpan data SKP Permenpan:",
      ...
      <div className="riwayat-header">
        <div>
          ...
          <p className="subtitle">
            Informasi riwayat SKP berdasarkan Permenpan.
          </p>
        </div>
        <button
