...
const RiwayatPenghargaan = ({ data: propData, employeeId: propEmployeeId }) => {
    ...
    try {
      ...
      if (modalType === "add") {
        response = await axios.post(
          `/api/employees/${employeeId}/penghargaan`,
          dataToSend,
          {
        ...
        response = await axios.put(
          `/api/employees/${employeeId}/penghargaan/${selectedData.id}`,
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
      ...
      console.error(
        "Gagal menyimpan data penghargaan:",
  ...
  const handleDelete = async () => {
    try {
      ...
      setPenghargaanData(
        penghargaanData.filter((item) => item.id !== selectedData.id)
      );
