// src/Pages/profile/RiwayatPenghargaan.jsx (Kode Final dengan Modal Sukses)
...
const RiwayatPenghargaan = ({ data: propData, employeeId: propEmployeeId }) => {
  ...
  const handleSaveChanges = async (e) => {
    ...
    try {
      if (modalType === 'add') {
        ...
        showSuccessModal(`Data penghargaan baru berhasil ditambahkan!`); // 4. Ganti alert
      } else {
        ...
        showSuccessModal(`Data penghargaan berhasil diperbarui!`); // 4. Ganti alert
      }
      handleCloseModal();
    } catch (error) {
  ...
  const handleDelete = async () => {
    try {
      ...
      showSuccessModal(`Data penghargaan telah dihapus!`); // 4. Ganti alert
      handleCloseModal();
    } catch (error) {
