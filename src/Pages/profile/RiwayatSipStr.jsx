    ...
    try {
      ...
      if (modalType === "add") {
        response = await axios.post(
          `/api/employees/${employeeId}/sipstr`,
          dataToSend,
          {
        ...
        response = await axios.put(
          `/api/employees/${employeeId}/sipstr/${selectedData.id}`,
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
    ...
    if ((modalType === "edit" || modalType === "add") && formData) {
      ...
      return (
        <form onSubmit={handleSaveChanges}>
          ...
          <div className="modal-form-group">
            <label htmlFor="tglBerlaku">Berlaku Sampai</label>
            <input
              type="date"
              id="tglBerlaku"
              name="tglBerlaku"
    ...
    if (modalType === "delete" && selectedData) {
      return (
        <div>
          ...
          <p>
            <strong>{selectedData.nomor}</strong>?
          </p>
          <div className="modal-form-actions">
            <button
              type="button"
  ...
  return (
    <div className="riwayat-container">
      <div className="riwayat-header">
        <div>
          <h3>Riwayat SIP & STR</h3>
          <p className="subtitle">
            Informasi riwayat Surat Izin Praktik dan Surat Tanda Registrasi.
          </p>
        </div>
        <button
          className="add-button-icon"
          title="Tambah Riwayat SIP/STR"
